...
export class TruesightApi implements ICredentialType {
	name = 'N8nDevTruesightApi';

	displayName = 'truesight API';

	icon: Icon = { light: 'file:../nodes/Truesight/truesight.svg', dark: 'file:../nodes/Truesight/truesight.dark.svg' };
	...
	properties: INodeProperties[] = [
		{
			...
			name: 'url',
			type: 'string',
			default: 'http://truesight.local',
			required: true,
			placeholder: 'http://truesight.local',
			description: 'The base URL of your truesight API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
