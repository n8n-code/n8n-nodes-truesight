# @n8n-dev/n8n-nodes-truesight

![truesight Banner](banner.svg)

[![npm version](https://img.shields.io/npm/v/@n8n-dev/n8n-nodes-truesight.svg)](https://www.npmjs.com/package/@n8n-dev/n8n-nodes-truesight)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

---

**Stop writing truesight API integrations by hand.**

Every time you connect n8n to truesight, you waste hours mapping endpoints, defining parameters, and debugging schemas. You copy-paste from docs, fix edge cases, and pray nothing breaks.

**What if connecting n8n to truesight took 5 minutes, not half a day?**

This node gives you **6+ resources** out of the box: **Actions**, **Applications**, **Devices**, **Groups**, **Historical Data**, and 1 more: with full CRUD operations, typed parameters, and zero manual configuration.
...
```bash
npm install @n8n-dev/n8n-nodes-truesight
```

**Or in n8n:**
1. **Settings → Community Nodes → Install**
2. Search: `@n8n-dev/n8n-nodes-truesight`
3. Click **Install**
...
2. Add credentials: **truesight API** → paste your API key
3. Drag the **truesight** node into your workflow
...
- Copy-pasting from truesight docs
- Debugging auth, pagination, error handling
- Maintaining your own client code

**With this node:**
- Install → configure → use. 5 minutes.
- Auto-generated from the official truesight OpenAPI spec
...
## Auto-Generated
This node was auto-generated from the official **truesight** OpenAPI specification using
[@n8n-dev/n8n-openapi-node-ultimate](https://github.com/kelvinzer0/n8n-openapi-node-ultimate),
then validated against the live API so you get accurate types and real parameters, not guesswork.

When the truesight API updates, this node updates too.
